        ...
        <footer className={styles.footer}>
            <div className={styles.container}>
                <div className={styles.logoSection}>
                    ...
                    <a href="mailto:support@leantime.io" className={styles.email}>
                        support@leantime.io
                    </a>
                </div>
                ...
                <div className={styles.links}>
                    <div className={styles.column}>
                        ...
                        <a href="/open-source">Open Source Solutions</a>
                        <a href="/chat">Community Chat</a>
                        <a href="/bug">Submit a Bug</a>
                    </div>
                    ...
                    <div className={styles.column}>
                        ...
                        <a href="/responsible">Responsible Disclosure Policy</a>
                    ...
                    <div className={styles.column}>
                        ...
                        <div className={styles.social}>
                            ...
                            <a href="https://github.com/Leantime/leantime" aria-label="GitHub" target="_blank" rel="noopener">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div className={styles.githubButton}>
                            <a
                                href="https://github.com/Leantime/leantime"
                                target="_blank"
